...
# ============================================================================
# GMAIL FUNCTIONS (Complete Working Implementation)
# ============================================================================
...
def delete_emails_from_sender(sender_email, count=10):
    ...
    try:
        ...
        print(f"❌ Delete emails from sender error: {e}")
...
def mark_email_as_read(email_id):
    ...
    try:
        ...
        print(f"❌ Mark email as read error: {e}")
...
def mark_email_as_important(email_id):
    ...
    try:
        ...
        return f"📧 Email marked as important"
        
    except Exception as e:
        print(f"❌ Mark email as important error: {e}")
        return f"❌ Failed to mark email as important: {str(e)}"
