"""
ROSE CALENDAR FUNCTIONS
Add these functions to Rose's main.py for direct Gmail work calendar access
Copy this entire file content into your main.py or import as a module
"""
...
# ============================================================================
# FUNCTION HANDLERS FOR OPENAI ASSISTANT
# ============================================================================
    ...
    try:
        ...
        if include_weather:
            try:
                ...
                briefing += "🌤️ **Weather**: ⚠️ Weather service unavailable\n\n"
        ...
        if include_personal:
            try:
                ...
                briefing += "📅 **Personal Schedule**: ⚠️ Personal calendar unavailable\n\n"
...
async def handle_rose_calendar_commands(message):
    ...
    Add this function call to your existing on_message handler
...
# ============================================================================
# FUNCTION HANDLERS DICTIONARY FOR OPENAI FUNCTION CALLING
# ============================================================================

# Add these to your existing function_handlers dictionary:
ROSE_CALENDAR_FUNCTION_HANDLERS = {
...
# In your existing function call handler, add:
